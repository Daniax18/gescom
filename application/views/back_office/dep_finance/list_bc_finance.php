                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($commande['status'] == 0) { ?>
                                            <a href="<?php echo site_url("index.php/back_office/BandcommandeController/validateCommandeFinance") ?>/<?php echo $commande['idboncommande']; ?>">
                                                <button class="btn btn-outline-success">
                                                    Valider
                                                </button>
                                            </a>
                                        <?php } else if($commande['status'] == 1){ ?>
                                            <a href="<?php echo site_url("index.php/back_office/BandcommandeController/devalidateCommandeFinance") ?>/<?php echo $commande['idboncommande']; ?>">
