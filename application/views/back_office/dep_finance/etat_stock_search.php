        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex flex-row justify-content-between align-items-center mb-3">
              <h3 class="text-start mb-3"> Evaluation de l'etat de stock : <?php echo $stock['nommateriel']  ?> </h3>
            ...
            <div class="container">  
              ...
              <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr >
                          <td> <?php echo $stock['idmateriel']; ?> </td>
                          <td> <?php echo $stock['nommateriel']; ?> </td>
                          <td> <?php echo $stock['qty']; ?> </td>
                          <td class = "text-end"> Ar <?php echo number_format( $stock['pu'], 2, ',', ' '); ?> </td>
                          <td class = "text-end"> Ar <?php echo number_format( $stock['montant_ht'], 2, ',', ' '); ?> </td>
                          <td class = "text-end"> Ar <?php echo number_format( $stock['montant_ttc'], 2, ',', ' '); ?> </td>
                        </tr>
                    </tbody>
                  </table>
                </div>
