<div class="page-content">
  ...
  <nav class="page-breadcrumb">
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page"> LISTE DES BON COMMANDES A LIVRER </li>
      </ol>
  </nav>
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex flex-row justify-content-between align-items-center mb-3">
              <h3 class="text-start mb-3">Recent Bon de Commandes a livrer : </h3>
            </div>
                      ...
                      <?php foreach($commandes as $commande){ ?>
                        <tr >
                          ...
                          <td class="text-center text-muted" style="width: 5%"> 
                            <a href="<?php echo site_url("index.php/back_office/dep_logistique/BonLivraisonClientController/getDetailCommandeNeedBonLivraisonClient") ?>/<?php echo $commande['idcommandeclient']; ?>">
