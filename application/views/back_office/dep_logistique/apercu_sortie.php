...
<div class="page-content">
  ...
  <nav class="page-breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page"> Apercu du Bon de Sortie a envoyer </li>
    </ol>
  </nav>
<?php
  if(isset($sortie)){ 
          ...
          <div class="card-body">
            <div class="container-fluid d-flex justify-content-between">
              <div class="col-lg-3 ps-0">
                ...
                <h4 class="mt-5 mb-2 text-muted">BON DE SORTIE to : </h4>
                <p> Departement <?php echo $sortie["nomdepartement"]?><br> </p>
              </div>
              <div class="col-lg-3 pe-0">
                <h4 class="fw-bolder text-uppercase text-end mt-4 mb-2"></h4>
                <h6 class="text-end mb-5 pb-4">Numero : <b><?php echo $sortie["idbonsortie"]; ?></b>  </h6>
                <p class="text-end mb-1"> Date Sortie : <?php echo $sortie["datesortie"]; ?> </p>
            ...
            <div class="container-fluid w-100">
              ...
              <span >Service Logistique ------------------------------------</span>
                  <span class="float-end">Departement Preneur  ------------------------------------</span>
                  <br/>
              <br/>
      ...
      <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalCenterTitle">Inserer Bon de sortie scan pdf:   </h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="btn-close"></button>
            </div>
              
            <form action="<?php echo site_url("index.php/back_office/dep_logistique/BonSortieController/saveBonSortie") ?>" method="POST" enctype="multipart/form-data">
